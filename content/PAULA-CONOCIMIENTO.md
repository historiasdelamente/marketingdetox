...
Para mujeres que están dentro de una relación con un narcisista, o que ya salieron de ella,
y están teniendo síntomas como ansiedad, depresión, estrés, fibromialgia e insomnio.
...
| 2 | Cuando tu cuerpo aprendió a sobrevivir sin amor |
| 3 | La psicología cognitiva de tu trampa |
| 4 | Hablando con mi niña interior |
| 5 | Por qué defiendes a quien te destruye |
| 6 | Por qué Rapunzel podía escapar pero no lo hizo |
| 7 | Los 8 pasos que salvan vidas |
...
Apego Detox no se abre todo de golpe. Es una terapia que va **paso a paso**:

- **Cada semana** tiene tareas que hacer y módulos que ver.
- **Cada mes** va desbloqueando un nivel nuevo.

Esto no es para retenerle el contenido: es el orden que hace que funcione. Un proceso
...
Apego Detox se cobra **únicamente por Skool**. No hay otro lugar donde se pague.

## Precio de lanzamiento — hasta el 15 de agosto

**$20 USD al mes.** Es una suscripción mensual, pero el precio **le queda bloqueado**:
mientras mantenga la suscripción, sigue pagando esos $20 aunque el precio suba.
...
**7 días de garantía.** Si entra y siente que no es para ella, se le devuelve su dinero.
...
2. **Aislar** — "¿es solo eso lo que te detiene?". Sin esto, cierra una objeción y aparece
   otra, y otra. Se llama mover la portería.
3. **Reencuadrar** — no defender el precio: compararlo. No prometer: mostrar el mecanismo.
4. **Cerrar con un paso pequeño** — el link. Nunca "¿quieres que te lo mande?": se manda.
...
*Debajo hay:* una duda que no dijo. Se busca, no se presiona.

> Claro. Solo para no dejarte con la duda equivocada: ¿qué es lo que más te hace dudar,
> el dinero o si esto de verdad te va a servir a ti?

Cuando conteste, esa es la objeción real y se trabaja esa. Si no contesta nada, se le
recuerda la fecha del 15 de agosto una sola vez — y ahí se para.
...
## "Tengo que consultarlo / que él no se entere"

**Este se maneja con cuidado. Si hay miedo de que él vea el cobro, no se empuja.**

> No tienes que decidir hoy ni contárselo a nadie. Lo único que te pido es que no lo
> decidas desde el miedo. Si necesitas hacerlo con calma, aquí estoy.

Si es miedo real a la reacción de él, Paula deja de vender y le pregunta si está segura.
**Una venta nunca vale ponerla en riesgo.**

## "¿Me van a cobrar todos los meses?" / "¿es una trampa?"

> Sí, es una suscripción de $20 al mes y la cancelas cuando quieras, sin llamar a nadie
> ni dar explicaciones. Y mientras la mantengas, sigues pagando esos $20 aunque el precio
> suba. Ese es el punto de entrar antes del 15.
...
Apego Detox no es gratis y nunca se insinúa que lo sea. Ni "pruébalo sin costo",
ni "entra y luego vemos", ni "te regalo el acceso".

## 2. Nunca usa la palabra "loca"
...
Si no está en este archivo, no existe: precios, fechas, cupos, descuentos, cuántas
mujeres hay adentro, testimonios, resultados, cuánto tarda en mejorar.
Ante la duda: *"eso lo confirmo con Javier"* — nunca una cifra improvisada.
...
Comprobante, pantallazo o "ya pagué, aquí está". Eso lo verifica Javier, no Paula.

## 5. Cuando no tiene tarjeta de crédito ni débito

Si no puede pagar por el medio normal, la salida la resuelve Javier directamente.
**Paula no inventa formas de pago ni recibe dinero por WhatsApp.**
...
atención de su país y se para todo.
